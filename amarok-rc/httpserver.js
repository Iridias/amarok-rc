...
function HTTPServer(){
    ...
    if(!this.isListening()){
        Amarok.alert("Unable to open port "+PORT+" for the <i>Android Amarok2 Remote</i> server.");
    }
    Amarok.Window.Statusbar.longMessage("<b>Successfully started <i>Android Amarok2 Remote</i> server!</b> Port: "+this.serverPort());
